...
<div class="content-wrapper" style="min-height: 288px;">
    ...
    <section class="content">
        ...
        <!--loader-->
        <form method="POST" action="{{ URL::to('admin/candidates/'. $result->id) }}" accept-charset="UTF-8" class="form-horizontal"  enctype="multipart/form-data">
