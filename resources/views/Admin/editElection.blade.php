...
@if ($errors->has('school_id_fk'))
 ...
 @endif  
@if ($errors->has('image'))
    <script> toastr.error("The image should be .jpg, .jpeg or .png","Error")</script>
 @endif  
<div class="content-wrapper" style="min-height: 288px;">
    ...
    <section class="content-header">
        <h1>
            election Manage
            <small>Update election</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
            <li><a href="{{ url('/admin/elections') }}">election Manage</a></li>
            <li class="active">Update election</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <!--loader-->
        <form method="POST" action="{{ URL::to('admin/electionUpdate/'. $result->id) }}" accept-charset="UTF-8" class="form-horizontal"  enctype="multipart/form-data">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
              {{ method_field('PUT')}}
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Update election</h3>
                ...
                <!-- /.box-header -->
                    ...
                    <div class="form-group">
                        <label for="last_name" class="col-lg-2 control-label">Election Date</label>
                        <div class="col-lg-10">
                            <input class="form-control" maxlength="191" required="required" placeholder="Address" name="address" type="text"  value="@if(isset($election->election_Date)){{$election->election_Date}}@endif ">
                        </div>
                        <!--col-lg-10-->
                    </div>
                    <!--form control-->
                    <div class="form-group">
                        <label for="password" class="col-lg-2 control-label">Election Start Time</label>
                        <div class="col-lg-10">
                ...
                <div class="box-footer">
                    ...
                    <a href="{{url('admin/elections')}}"  class="btn btn-default">Cancel</a>
