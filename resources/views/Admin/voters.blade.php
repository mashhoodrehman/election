...
<div class="content-wrapper" style="min-height: 289px;">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">voter Manage</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">Active voters</h3>
                <div class="box-tools pull-right">
                    <div class="pull-right mb-10 hidden-sm hidden-xs">
                        <a href="{{ url('admin/addvoter') }}" class="btn btn-primary btn-xs">Add voters</a>
<!--                         <a href="admin/access/user/create" class="btn btn-success btn-xs">Create voter</a>
                        <a href="admin/access/user/deactivated" class="btn btn-warning btn-xs">Deactivated voters</a>
                        <a href="admin/access/user/deleted" class="btn btn-danger btn-xs">Deleted voters</a> -->
                    </div>
                    <!--pull right-->
                    <div class="pull-right mb-10 hidden-lg hidden-md">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/admin/access/user') }}">All voters</a></li>
<!--                                 <li><a href="admin/access/user/create">Create voter</a></li>
                                <li class="divider"></li>
                                <li><a href="admin/access/user/deactivated">Deactivated voters</a></li>
                                <li><a href="admin/access/user/deleted">Deleted voters</a></li> -->
                            </ul>
                        </div>
                        <!--btn group-->
                    </div>
                        ...
                        <table id="users-table" class="table table-condensed table-hover dataTable no-footer" role="grid" aria-describedby="users-table_info">
                            ...
                            @if(isset($result))
                                ...
                                <tr role="row" class="odd" id="{{$data->id}}">
                                    ...
                                    <td>{{$data->zip}}</td>
                                    <td>
                                        <a href="{{ URL::to('admin/voters/' .$data->id ) }}" class="btn btn-xs btn-info"><i class="fa fa-eye" data-toggle="tooltip" data-placement="top" title="View"></i></a> 
                                        <a href="{{url('admin/voters/edit')}}/{{$data->id}}" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Edit"></i>
                                        </a> 
            ...
            $.ajax({
                ...
                success: function (data) {
                  if (data.response=="ok") {
                     console.log(data.id);
                    $('#'+data.id).remove();
                        toastr.success('voter Deleted Succesfully',"Deleted");
                  }
                    }         
            });
    });
