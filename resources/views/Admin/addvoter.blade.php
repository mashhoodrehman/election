...
<div class="content-wrapper" style="min-height: 288px;">
    ...
    <section class="content-header">
        <h1>
            voter Manage
            <small>Create voter</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/admin/dashboard') }}">Dashboard</a></li>
            <li><a href="{{ url('/admin/voters') }}">voter Manage</a></li>
            <li class="active">Create voter</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <!--loader-->
        <form method="POST" action="{{ url('admin/voters') }}" class="form-horizontal"  enctype="multipart/form-data">
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input class="form-control" maxlength="191" required="required" placeholder="Address" name="address" type="text" id="last_name">
                        </div>
                        <!--col-lg-10-->
                    </div>
                    <!--form control-->
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                        <textarea required class="form-control" placeholder="About" name="about"></textarea>
                        </div>
                        <!--col-lg-10-->
                    </div>
                    <!--form control-->
                ...
                <div class="box-footer">
                    ...
                    <a href="{{url('admin/voters')}}"  class="btn btn-default">Cancel</a>
