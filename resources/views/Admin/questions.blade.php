            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <div class="pull-right mb-10 hidden-sm hidden-xs">
                        <a href="{{ url('/admin/addquestions') }}" class="btn btn-primary btn-xs">Add Question</a>
                    </div>
                    <!--pull right-->
                        ...
                        <table id="users-table" class="table table-condensed table-hover dataTable no-footer" role="grid" aria-describedby="users-table_info">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="users-table" rowspan="1" colspan="1" aria-label="First Name: activate to sort column ascending">Question</th>
                            ...
                            @foreach($question as $data)
                                <tr role="row" class="odd" id="{{$data->id}}">
                                    ...
                                    <td>{{$data->question}}</td>
                                    <td>
                                        <a href="{{ URL::to('admin/questions/' .$data->id ) }}" class="btn btn-xs btn-info"><i class="fa fa-eye" data-toggle="tooltip" data-placement="top" title="View"></i></a> 
                                        <a href="{{ URL::to('admin/questions/edit/'.$data->id ) }}" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Edit"></i>
                                        </a> 
                                        <a href="#" class="button btn btn-xs btn-danger delete_btn  " data-id="{{$data->id}}">
    ...
    swal({
        ...
        function() {
            ...
            $.ajax({
             ...
             console.log(data);
            $('#'+data.id).remove();
            toastr.success('Question Deleted Succesfully' , 'Delete');
