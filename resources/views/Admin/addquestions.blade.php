...
<div class="content-wrapper" style="min-height: 288px;">
    ...
    <section class="content">
        ...
        <!--loader-->
        <form method="POST" action="{{ url('admin/questions') }}" class="form-horizontal"  enctype="multipart/form-data">
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input class="form-control" maxlength="191" required="required" autofocus="autofocus" placeholder="Add Question" name="question" type="text">
...
{{--                         <div class="form-group">
                            <label  class="col-lg-2 control-label">Answer</label>
                                <div class="col-lg-5">
                                    <input class="form-control" maxlength="191" required="required" autofocus="autofocus" placeholder="Enter Answer" name="answer[]['answer']" type="text">                            
                                </div>                            
                                <div class="col-lg-3">
                                    <input class="form-control" maxlength="191" min="0" max="100" required="required" autofocus="autofocus" placeholder="Enter Weight Percentage" name="answer[]['weight']" type="number">
                                </div>                            
                                <div class="col-lg-2">
                                    <a class="btn btn-danger btn-md delete_btn">Delete</a>  
                                </div>
